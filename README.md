...
2.7.1 (Build: 2016012500)
Fixed bar graph which showed more than the max width of 100 percent.  
All non-student roles now default to the My students tab.
Distinguished 'General feedback' from the 'Full feedback' (link) column titles on the Feedback comments tab.
Fixed the draft submission showing an icon displaying late when you hover, when no icon or message should display.  
Changed the text of the self-added Turnitin feedback link so it is clearer and more concise.
